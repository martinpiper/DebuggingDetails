...
..\..\C64\bin\TapeTool.exe n 1 w  "cyberdyne.tap" a m "Loaders.map" otl$c0 otfb "Picture2.prg" 1 c
..\..\C64\bin\TapeTool.exe n 1 w  "cyberdyne.tap" a m "Loaders.map" otl$c0 otfb "Picture3.prg" 1 c
..\..\C64\bin\TapeTool.exe n 1 w  "cyberdyne.tap" a m "Loaders.map" otl$c0 otfb "Intro.prg" 1 c
..\..\C64\bin\TapeTool.exe n 1 w  "cyberdyne.tap" a m "Loaders.map" otl$c0 otfb "Game.prg" 1 c
